...
\textbf{Notes on format.} The manuscript is a theoretical contribution. Its main narrative --- the
numbered Sections 1--8 --- is 17 pages; the proofs, the full experimental record and the extended
discussion of the related work and of the limitations are in lettered appendices, as is usual for
this kind of work. The manuscript holds ten figures and tables in total, matching the journal's
guideline for a theoretical article; four further figures, each supporting a claim the
manuscript also establishes by other means, are supplied as Supplementary Material. I confirm that this work is
