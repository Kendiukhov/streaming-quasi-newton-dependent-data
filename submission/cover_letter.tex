...
long simulation are public at
\url{https://github.com/Kendiukhov/streaming-quasi-newton-dependent-data}. Each of the 99
references was verified against its published source. The total compute is a few CPU-hours on one
machine.
