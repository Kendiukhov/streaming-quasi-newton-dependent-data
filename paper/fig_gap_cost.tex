...
\centering
\IfFileExists{fig3_gapping.pdf}{\includegraphics[width=\linewidth]{fig3_gapping.pdf}}{\fbox{\parbox{0.9\linewidth}{\centering\vspace{2em}\texttt{\detokenize{fig3_gapping}} pending\vspace{2em}}}}
...
\begin{minipage}[t]{0.485\linewidth}
\centering
\IfFileExists{fig4_cost.pdf}{\includegraphics[width=\linewidth]{fig4_cost.pdf}}{\fbox{\parbox{0.9\linewidth}{\centering\vspace{2em}\texttt{\detokenize{fig4_cost}} pending\vspace{2em}}}}
