...
\begin{figure}[t]
\centering
\IfFileExists{fig7_lrv_rate.pdf}{\includegraphics[width=\linewidth]{fig7_lrv_rate.pdf}}{\fbox{\parbox{0.9\linewidth}{\centering\vspace{2em}\texttt{\detokenize{fig7_lrv_rate}} pending\vspace{2em}}}}
