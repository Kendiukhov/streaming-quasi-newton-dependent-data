% \Needspace* is not decoration: the first chunk of this longtable (caption, head, and
% the break-protected first panel) has no legal breakpoint inside it, so on a page with
% less room than that it runs into the bottom margin without any warning.
