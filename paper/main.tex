...
long-run sandwich for the inversion-free rank-one curvature recursion under geometric
mixing---the regime where the martingale argument behind the independent-data analysis fails.
...
inverse can be maintained directly by the Sherman--Morrison identity
\citep{sherman1950adjustment} without ever forming or inverting a matrix
...
\item \textbf{An exponentially small block-length bias} (\Cref{thm:lrv}). What makes
      ...
      the $O(1/b)$ of plain batch means. The correction and this tail-sum property are due
